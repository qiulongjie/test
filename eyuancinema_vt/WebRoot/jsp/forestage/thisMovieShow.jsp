				...
				<div style="width:775px; float:left; margin-top:10px; ">
					...
					<div style="padding:0px 20px 30px 80px;line-height:18px;"
						...
						<div style="width:660px; ">
							...
							<div align="center" style="height:35px;" class="showtitle">本片影讯</div>
			...
			<table width="1000" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td width="1000" align="center" class="centerbj"><table
						...
						<table width="845" border="0" align="center" cellpadding="0"
							cellspacing="0" style="margin-top:20px; margin-bottom:5px;">
							<tr>
								<td align="left" bgcolor="#FFFFFF" valign="middle"
									style="padding-bottom:15px; padding-left:8px;"><script
										src="../../SH_smallcode.asp-typ=friend" charset="utf-8"></script>
								</td>
							</tr>
						</table>
