...
<div id="center" style="width:1000px;">
	...
	<div id="cc" style="width:1000px; float:left;">
		...
		<div style="width:613px; float:left; padding-top:25px;" align="center">
			...
			<div class="pic"><img height="330" alt="" width="500" src="../../image/1-120922102353494.jpg"  /></div>
            <p>&nbsp;</p>
            <p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;9月14日下午，奥运冠军孙杨在艺缘影厅与我校师生见面交流，并为学生亲切签名。我校赠送孙杨杨柳青年画，表达深深祝福，年画题为《年年有鱼》，寓意年年都拿冠军。学生代表向孙杨献花，并与孙杨合影。<br/>
  　　&nbsp;&nbsp;&nbsp;&nbsp;在与我校学子的交流中，孙杨称赞了我校校园及体育场馆的建设。他说，天津的大学城比他去过的大学城还要漂亮的多，天津工业大学绿化很好。<br/>
 &nbsp;&nbsp;&nbsp;&nbsp;我校接待部负责人表示，“天津工大大运村已经正式进入工作状态，对于一些明星队员的安排，学校也做好了预案。我们的原则是让每一位住在天津工大的运动员和教练员都能够吃好、住好全身心地投入到比赛中去。”</p>
...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
  <tbody>
        ...
        <tr>
            <td background="../../fengefu-3.gif"  height="4">&nbsp;</td>
        </tr>
        <tr>
            <td height="10">&nbsp;</td>
        </tr>
...
<div class="pic">&nbsp;<img height="335" alt="" width="500" src="../../image/1-1209221020209B.jpg"  /></div>
<p>&nbsp;</p>
<p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;　2012年8月7日下午6点，我校艺缘影厅迎来了曾执导《泰坦尼克号》、《阿凡达》等多部大片的国际著名导演詹姆斯•卡梅隆先生和3D技术大师文斯•佩斯先生。<br/>
&nbsp;&nbsp;&nbsp;&nbsp;在影厅中，卡梅隆先生为全场一千五百余名同学展示了其3D制作团队的电影魅力。为同学们播放了由卡梅隆-佩斯集团制作的3D短片，包括一个特效宣传片和一个预告片。<br/>
&nbsp;&nbsp;&nbsp;&nbsp;现场，卡梅隆先生还与学生们畅谈3D电影技术和3D电影未来。他谈到：“我本次来到天津是因为CPG的中国公司成立了，该公司由我们的卡梅隆-佩斯集团和天津海泰控股集团、天津北方电影集团共同出资成立，公司旨在共同促进3D的发展。它叫CPG中国，C代表卡梅隆，P代表佩斯，我们在中国，谢谢大家的鼓励。欢迎同学们来我的公司工作！” 

</p>
<table cellspacing="0" cellpadding="0" width="100%" border="0">
    <tbody>
        <tr>
            <td align="center" width="80%" height="5">&nbsp;</td>
        </tr>
        <tr>
            <td background="../../fengefu-3.gif"  height="4">&nbsp;</td>
        </tr>
...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0px; padding:0px;">
    ...
    <tr>
      <td height="27" align="left" valign="middle" class="bookingbj2" onmousemove="this.className='bookingbj3'" onmousedown="this.className='bookingbj3'" onmouseout="this.className='bookingbj2'"><a href="questions.asp.jsp" ><font color="#333333">疑难解答</font></a></td>
    </tr>
    <tr>
      <td height="27" align="left" valign="middle" class="bookingbj2" onmousemove="this.className='bookingbj3'" onmousedown="this.className='bookingbj3'" onmouseout="this.className='bookingbj2'"><a href="traffic.jsp" ><font color="#333333">影院交通指南</font></a></td>
    </tr>
    <tr>
      <td height="27" align="left" valign="middle" class="bookingbj2" onmousemove="this.className='bookingbj3'" onmousedown="this.className='bookingbj3'" onmouseout="this.className='bookingbj2'"><a href="buytickets.jsp" ><font color="#333333">影院购票指南</font></a></td>
    </tr>
  </table>
</div>
