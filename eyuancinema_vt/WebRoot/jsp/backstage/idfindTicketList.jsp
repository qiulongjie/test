	...
	<table width="100%" border="0" bordercolor="blue">
			...
			<%for(int i = 0;i<relist.size();i++){ %>
				<tr>
					...
					<td>未出票</td>
					<td><a href="ticket_ticketIdSerchOut?ticketId=<%=((SimpleTicketInfo)relist.get(i)).getTicketId() %>"
						onclick="return confirm('确定出票？')">出票</a>
						<a href="ticket_ticketIdSerchDelete?ticketId=<%=((SimpleTicketInfo)relist.get(i)).getTicketId() %>"
